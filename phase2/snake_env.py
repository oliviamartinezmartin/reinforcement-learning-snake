...
class SnakeGameEnv:
    ...
    def get_state(self):
        """
        HECHO POR NOSOTRAS
        This method returns the current state of the game in a tuple,
        using the selected variables, detailed in the report.
        """
        current_direction = self.direction
        direction_of_food = self.direction_of_food()

        # Calculating the next coordinates if the snake were to continue
        # straight.
        x, y = self.snake_pos
        ...
        danger_ahead = self.will_die(next_x, next_y)
        return (current_direction, direction_of_food, danger_ahead)
